...
With the paper's outlined website architecture and REST API implementation and its prove of effectiveness, such approach to educational website development can be expected to be implemented with our project.
...
The core of the study suggests that a good evaluation system should be carefully planned to be fair and useful. The authors recommend using standardized online forms with about 10 to 30 questions that are easy for students to understand. This approach was chosen because online tools are faster, save paper, and make it easier for teachers to see their results quickly. To keep students from getting "survey fatigue," the study suggests giving them dedicated time during class to finish the evaluations.

The research found that these evaluations are most effective when they focus on "scholarly teaching"—meaning the questions ask about clear goals, good preparation, and how well the teacher presents the material. The study also notes that while online evaluations might have fewer students responding than paper ones, the actual scores and feedback are usually the same.

For future improvements, the authors suggest that schools should use random sampling to get reliable feedback without asking every student every time, create a clear plan for who gets to see the results and how they will be used to help teachers grow, train mentors to help faculty members understand their feedback and make positive changes to their courses.

NOT SURE WHETHER TO INCLUDE OR NOT