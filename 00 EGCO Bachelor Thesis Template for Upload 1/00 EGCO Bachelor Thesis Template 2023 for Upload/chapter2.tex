...
Technically, the prototype is built using the MERN stack (MongoDB, Express.js, React.js, and Node.js). By leveraging React.js for the frontend, the system ensures a responsive user experience, while Node.js and MongoDB allow for scalable data management and efficient handling of concurrent user requests. The implementation also features Role-Based Access Control (RBAC), ensuring that only authorized users—such as administrators or teachers—can post official notices, while students are restricted to viewing and participating in discussions.

The research concludes that transitioning to a digital framework significantly improves user engagement and reduces the risk of miscommunication. For future development, the author suggests further optimizing the user experience and exploring additional features to maximize the platform's impact on institutional knowledge sharing.

The paper contributes to the project by presenting a road map of website development which can be taken as an example to improve and guide our project planning. Additionally, 
