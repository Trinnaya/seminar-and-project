...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Thesis Title 
\newcommand{\thesisTitle}{An integrated academic planning and course\\ rating web platform for EGCI students
}
...
\newcommand{\thesisFirstAuthorName}{TRINNAYA}
\newcommand{\thesisFirstAuthorLastName}{DAMRONGPATHARAWAT}
...
\newcommand{\thesisFirstAuthorID}{6581147}
\newcommand{\thesisFirstAuthorBD}{26 December 2004}
\newcommand{\thesisFirstAuthorBP}{Nakhon Ratchasima, Thailand}
\newcommand{\thesisFirstAuthorHC}{Mahidol International College}
\newcommand{\thesisFirstAuthorTel}{098 454 9415}
\newcommand{\thesisFirstAuthorEmail}{trinnaya.dam@student.mahidol.edu}

%Second Author name
\newcommand{\thesisSecondTitleName}{MR. }		%Comment all if you don't have second author
\newcommand{\thesisSecondAuthorName}{KYAW ZIN}
\newcommand{\thesisSecondAuthorLastName}{THANT}
...
\newcommand{\thesisSecondAuthorID}{6581178}
\newcommand{\thesisSecondAuthorBD}{11 August 2003}
\newcommand{\thesisSecondAuthorBP}{Yangon, Myanmar}
\newcommand{\thesisSecondAuthorHC}{Mahidol International College}
\newcommand{\thesisSecondAuthorTel}{082 582 5476}
\newcommand{\thesisSecondAuthorEmail}{kyawzin.tha@student.mahidol.edu}

%Third Author name
\newcommand{\thesisThirdTitleName}{MR.}			%Comment all if you don't have third author
\newcommand{\thesisThirdAuthorName}{NATHAN}
\newcommand{\thesisThirdAuthorLastName}{TANABORIBOON}
...
\newcommand{\thesisThirdAuthorID}{6681224}
\newcommand{\thesisThirdAuthorBD}{17 September 2006}
\newcommand{\thesisThirdAuthorBP}{Bangkok, Thailand}
\newcommand{\thesisThirdAuthorHC}{Mahidol International College}
\newcommand{\thesisThirdAuthorTel}{093 020 7448}
\newcommand{\thesisThirdAuthorEmail}{nathan.tan@student.mahidol.edu}
...
%Advisor name
\newcommand{\thesisAdv}{Dr. LALITA NARUPIYAKUL}		%with title name
\newcommand{\thesisAdvTH}{ดร. ชื่อที่ปรึกษา นามสกุลที่ปรึกษา}		%with title name
\newcommand{\advDegree}{Ph.D. (Computer Science),\\ Ph.D. (Computer and Electrical Engineering)}
