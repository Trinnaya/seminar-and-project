...
\begin{enumerate}
    ...
    \item Allows EGCI students to rate the any available General Education courses, major required course, and engineering core course offered by MUIC and EGCI faculty, as a score from 0 to 5 and allows users to leave a comment anonymously.
