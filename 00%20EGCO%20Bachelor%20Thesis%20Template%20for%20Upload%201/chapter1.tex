...
\section{Objectives}
\begin{itemize}
	\item To analyze user behaviours regarding academic tool usage among EGCI students, including how students currently share and compare class schedules with peers, what course-related information students seek before enrollment such as course difficulty, workload, and professor teaching style, and how students approach long-term academic planning in terms of tracking prerequisites, selecting elective courses, and managing their progression toward graduation
...
\section{Data restriction for each component}
\begin{itemize}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item The proposed system is expected to achieve a user base of 12 or more.
		\item The Rate-My-Course reaches the number for activities: 5 for adding star-rating and tags, and 2 for leaving comments.
		\item The Class Schedule Matcher targets a number of 10 screenshots uploaded to find common free times, with all being accurately matched.
		\item The Super Planner aims to facilitate at least 3 unique student plans.
		\item The project aims to collect User Experience (UX) based on quality feedback collected from a random group of users.
	\end{itemize}
