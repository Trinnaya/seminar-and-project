...
\section{Objectives}
\begin{itemize}
	\item To design a web interface, system architecture, and develop a website for EGCI students that integrates:
	...
	\end{enumerate}
	\item To evaluate the website’s performance in terms of functional accuracy, user engagement and task efficiency across all functions, and the overall user experience (UX).
...
\begin{enumerate}
	...
	\item System Performance Evaluation based on following dimensions:
	\begin{itemize}
		\item Each system component is tested for functional correctness by verifying that outputs match expected results.
		\item A scenario-based test is conducted where the same group of users is given predefined tasks to complete within a set time limit.
		\item User Experience (UX) is based on quality feedback collected from a random group of 20 users using a structured questionnaire.
	\end{itemize}
